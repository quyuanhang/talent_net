...
def feed_dict(data, model, training=True):
    labels, jds, jd_kws, jd_skill, cvs, cv_kws, cv_skill, \
    cate_features, cate_feature_ids, his_cvs, his_cv_kws, his_cv_skill = data
    fd = {
        "history/doc:0": his_cvs,
        "history/skill:0": his_cv_skill,
        "history/keywords:0": his_cv_kws,
        "jds/doc:0": jds,
